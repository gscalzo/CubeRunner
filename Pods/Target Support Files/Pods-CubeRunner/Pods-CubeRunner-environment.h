...
// BitwiseFont
#define COCOAPODS_POD_AVAILABLE_BitwiseFont
#define COCOAPODS_VERSION_MAJOR_BitwiseFont 0
#define COCOAPODS_VERSION_MINOR_BitwiseFont 1
#define COCOAPODS_VERSION_PATCH_BitwiseFont 0
